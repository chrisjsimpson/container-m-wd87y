...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-m-wd87y.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-m-wd87y.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-m-wd87y.git
cd container-m-wd87y
```
...
```
docker attach container-m-wd87y
```
